...
class TestAccountInvoice(unittest.TestCase):
    ...
    def test_validate_validated_invoice(self):
        ...
        self.assertEqual(
            str(err.exception),
            f"Error! This invoice has already been validated!: {invoice.id}",
        )
    ...
    def test_validate_empty_invoice(self):
        ...
        self.assertEqual(
            str(err.exception),
            f"Error! This invoice is empty; you cannot validate it! : {invoice.id}",
        )
    ...
    def test_cancel_validated_invoice(self):
        ...
        self.assertEqual(
            str(err.exception),
            f"Error! Cannot cancel a validated invoice!: {invoice.id}",
        )
    ...
    def test_pay_paid_invoice(self):
        ...
        self.assertEqual(
            str(err.exception),
            f"Error! This invoice has already been paid!: {invoice.id}",
        )
    ...
    def test_pay_non_validated_invoice(self):
        ...
        self.assertEqual(
            str(err.exception),
            f"Error! Cannot pay a not validated invoice!: {invoice.id}",
        )
    ...
    def test_add_line_to_validated_invoice(self):
        ...
        self.assertEqual(
            str(err.exception),
            f"Error! You cannot add a line to a validated invoice!: {invoice.id}",
        )
    ...
    def test_add_line_to_cancelled_invoice(self):
        ...
        self.assertEqual(
            str(err.exception),
            f"Error! You cannot add a line to a cancelled invoice!: {invoice.id}",
        )
